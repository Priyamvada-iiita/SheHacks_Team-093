...
else if(Jaipur.checked==true){
    result2.innerHTML="*Sriram Nagar,, 92, Rajasthan State Highway 2C, Sriram Nagar, Jhotwara, Jaipur, Rajasthan 302032*";
}
else if(Chennai.checked==true){
    result3.innerHTML="*Government General Hospital Poonamallee High Road, Park Town, Chennai-600003*";
}
else if(Allahabad.checked==true){
